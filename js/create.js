...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById('formMain').addEventListener('input', debounce(generateJSON, 400));
  document.getElementById('formMain').addEventListener('change', debounce(generateJSON, 400));
});
  ...
  block.innerHTML = `
    ...
    <div class="talent-block__body">
      <div class="field">
        ...
        <input type="text" class="field-input" data-field="name" placeholder="天賦名を入力してください。">
      </div>
      <div class="field">
...
function addPassiveBlock() {
  ...
  block.innerHTML = `
    ...
    <div class="field">
      ...
      <input type="text" class="field-input" data-field="name" placeholder=" ">
    </div>
    <div class="field">
      ...
      <div class="constellation-block__fields">
        <div class="field">
          <input type="text" class="field-input" data-const-field="name" data-const="${i}"
                 placeholder="星座名を入力してください。">
        </div>
        <div class="field">
          <textarea class="field-textarea" data-const-field="effect" data-const="${i}"
                    rows="2" placeholder="凸効果の説明を入力してください。"></textarea>
        </div>
      </div>`;
    container.appendChild(block);
  }
